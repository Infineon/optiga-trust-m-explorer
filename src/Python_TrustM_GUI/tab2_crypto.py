...
class Tab_ECC(wx.Panel):
    def __init__(self, parent):
        ...
        self.ecctype = wx.ComboBox(
            self, 1, choices=ecctype_list, style=wx.CB_READONLY, size=wx.Size(170, 30)
        )
        self.ecctype.SetFont(textctrlfont)

        text_keyusage = wx.StaticText(self, 0, "Key_usage:")
        self.keyusage = wx.ComboBox(
            self, 1, choices=keyusage1, style=wx.CB_READONLY, size=wx.Size(170, 30)
        )
        ...
        button_eccverify.SetToolTip(
            wx.ToolTip("Verify the signature using OPTIGA™ Trust M library")
        )
    ...
    def OnGenKey(self, evt):
        ...
        if self.ecctype.GetSelection() == 0:
            if self.keyslot.GetSelection() == 1:
                ...
                command_output = exec_cmd.execCLI(["cat", "test_e0f1_pub.pem"])
                ...
                meta_output = exec_cmd.execCLI(
                    [config.EXEPATH + "/bin/trustm_metadata", "-r", "0xe0f1"]
                )
                ...
                command_output = exec_cmd.execCLI(["cat", "test_e0f2_pub.pem"])
                ...
                meta_output = exec_cmd.execCLI(
                    [config.EXEPATH + "/bin/trustm_metadata", "-r", "0xe0f2"]
                )
                ...
                command_output = exec_cmd.execCLI(["cat", "test_e0f3_pub.pem"])
                ...
                meta_output = exec_cmd.execCLI(
                    [config.EXEPATH + "/bin/trustm_metadata", "-r", "0xe0f3"]
                )
    ...
    def OnECCsign(self, evt):
        ...
        exec_cmd.createProcess("echo " + input_message + " > data_input.txt")
        ...
        if self.ecctype.GetSelection() == 0:
            if self.keyslot.GetSelection() == 0:
                command_output = exec_cmd.execCLI(
                    [
                        config.EXEPATH + "/bin/trustm_ecc_sign",
                        "-k",
                        "0xe0f0",
                        "-o",
                        "ecc_signature.bin",
                ...
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f0 -o ecc_signature.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText("'python3 emulator.py ecc_signature.bin' executed \n")
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f2 -o ecc_signature.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f3 -o ecc_signature.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
        ...
        # ecc signing for ECC384
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f1 -o ecc_signature_384.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'python3 emulator.py ecc_signature_384.bin' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f2 -o ecc_signature_384.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f3 -o ecc_signature_384.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f1 -o ecc_signature_521.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'python3 emulator.py ecc_signature_521.bin' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f2 -o ecc_signature_521.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f3 -o ecc_signature_521.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f1 -o ecc_signature_BP256.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'python3 emulator.py ecc_signature_BP256.bin' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f2 -o ecc_signature_BP256.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f3 -o ecc_signature_BP256.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f1 -o ecc_signature_BP384.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'python3 emulator.py ecc_signature_BP384.bin' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f2 -o ecc_signature_BP384.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f3 -o ecc_signature_BP384.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f1 -o ecc_signature_BP512.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'python3 emulator.py ecc_signature_BP512.bin' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f2 -o ecc_signature_BP512.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_sign -k 0xe0f3 -o ecc_signature_BP512.bin -i data_input.txt -H -X' executed \n"
                )
                command_output = exec_cmd.execCLI(
                    [
                        "python3",
    ...
    def OnECCverify(self, evt):
        ...
        if self.ecctype.GetSelection() == 0:
            ...
            if self.keyslot.GetSelection() == 0:
                ...
                self.text_display.AppendText(
                    "'trustm_cert -r 0xe0e0 -o cert_0xe0e0.pem executed' \n"
                )
                exec_cmd.createProcess(
                    "openssl x509 -pubkey -noout -in cert_0xe0e0.pem > test_e0f0_pub.pem"
                )
                self.text_display.AppendText(
                    "'openssl x509 -pubkey -noout -in cert_0xe0e0.pem > test_e0f0_pub.pem' executed \n"
                )

                command_output = exec_cmd.execCLI(
                    [
                        config.EXEPATH + "/bin/trustm_ecc_verify",
                        "-i",
                        "data_input.txt",
                        "-s",
                        "ecc_signature.bin",
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature.bin -p test_e0f0_pub.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f2_pub.bin -outform PEM -out test_e0f2_pub.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature.bin -p test_e0f2_pub.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f3_pub.bin -outform PEM -out test_e0f3_pub.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature.bin -p test_e0f3_pub.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f1_pub_384.bin -outform PEM -out test_e0f1_pub_384.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_384.bin -p test_e0f1_pub_384.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f2_pub_384.bin -outform PEM -out test_e0f2_pub_384.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_384.bin -p test_e0f2_pub_384.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f3_pub_384.bin -outform PEM -out test_e0f3_pub_384.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_384.bin -p test_e0f3_pub_384.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f1_pub_521.bin -outform PEM -out test_e0f1_pub_521.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_521.bin -p test_e0f1_pub_521.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f2_pub_521.bin -outform PEM -out test_e0f2_pub_521.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_521.bin -p test_e0f2_pub_521.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f1_pub_BP256.bin -outform PEM -out test_e0f1_pub_BP256.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_BP256.bin -p test_e0f1_pub_BP256.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f2_pub_BP256.bin -outform PEM -out test_e0f2_pub_BP256.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_BP256.bin -p test_e0f2_pub_BP256.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f3_pub_BP256.bin -outform PEM -out test_e0f3_pub_BP256.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_BP256.bin -p test_e0f3_pub_BP256.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f1_pub_BP384.bin -outform PEM -out test_e0f1_pub_BP384.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_BP384.bin -p test_e0f1_pub_BP384.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f2_pub_BP384.bin -outform PEM -out test_e0f2_pub_BP384.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_BP384.bin -p test_e0f2_pub_BP384.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f3_pub_BP384.bin -outform PEM -out test_e0f3_pub_BP384.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_BP384.bin -p test_e0f3_pub_BP384.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f1_pub_BP512.bin -outform PEM -out test_e0f1_pub_BP512.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_BP512.bin -p test_e0f1_pub_BP512.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl ec -pubin -inform DER -in test_e0f2_pub_BP512.bin -outform PEM -out test_e0f2_pub_BP512.pem' executed \n"
                )
                ...
                self.text_display.AppendText(command_output)
                self.text_display.AppendText(
                    "'trustm_ecc_verify -i data_input.txt -s ecc_signature_BP512.bin -p test_e0f2_pub_BP512.pem -H -X' executed \n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
...
class Tab_RSA(wx.Panel):
    def __init__(self, parent):
        ...
        self.rsatype = wx.ComboBox(
            self, 1, choices=rsatype_list, style=wx.CB_READONLY, size=wx.Size(170, 30)
        )
        self.rsatype.SetFont(textctrlfont)

        text_keyusage = wx.StaticText(self, 0, "Key_usage:")
        self.keyusage = wx.ComboBox(
            self, 1, choices=keyusage, style=wx.CB_READONLY, size=wx.Size(170, 30)
        )
        self.keyusage.SetFont(textctrlfont)
        ...
        button_rsadec.SetToolTip(
            wx.ToolTip(
                "Decrypt data using the OID Key selected, an encrypted file datain.enc and output to datain.dec"
            )
        )
        button_rsasign.SetToolTip(
            wx.ToolTip("Hash and Sign the Message using OPTIGA™ Trust M RSA key")
        )
        button_rsaverify.SetToolTip(
            wx.ToolTip("Verify the Signature Using OPTIGA™ Trust M Library")
        )
    ...
    def OnEnc(self, evt):
        ...
        if self.rsatype.GetSelection() == 0:
            ...
            if self.keyslot.GetSelection() == 0:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl rsa -pubin -inform DER -in rsa_e0fc_pub_1024.bin -outform PEM -out rsa_e0fc_pub_1024.pem' executed \n"
                )
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl rsa -pubin -inform DER -in rsa_e0fd_pub_1024.bin -outform PEM -out rsa_e0fd_pub_1024.pem' executed \n"
                )
            ...
            if self.keyslot.GetSelection() == 0:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl rsa -pubin -inform DER -in rsa_e0fc_pub_2048.bin -outform PEM -out rsa_e0fc_pub_2048.pem' executed \n"
                )
            ...
            if self.keyslot.GetSelection() == 1:
                ...
                exec_cmd.createProcess(openssl_command)
                self.text_display.AppendText(
                    "'openssl rsa -pubin -inform DER -in rsa_e0fd_pub_2048.bin -outform PEM -out rsa_e0fd_pub_2048.pem' executed \n"
                )

        self.text_display.AppendText("\nStoring data in datain.txt...\n")

        datain = self.input_display.GetValue()
        exec_cmd.createProcess("echo " + datain + " > datain.txt")
        ...
        #         self.Update()
        self.text_display.AppendText(
            "'trustm_rsa_enc -p " + pubkey + " -o datain.enc -i datain.txt executed\n"
        )
        self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
    ...
    def OnDec(self):
        ...
        self.text_display.AppendText(output_message)
        self.text_display.AppendText(
            "'trustm_rsa_dec -k " + keyslot + " -o datain.dec -i datain.enc executed\n"
        )
        self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
    ...
    def OnSign(self, evt):
        ...
        self.text_display.AppendText(output_message)
        self.text_display.AppendText(
            "'trustm_rsa_dec -k " + keyslot + " -o " + outfile + " -i datain.txt executed\n"
        )
        self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
        ...
        self.text_display.AppendText("python3 emulator.py " + outfile + " executed \n")
        self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
    ...
    def OnVerify(self, evt):
        ...
        if self.rsatype.GetSelection() == 0:
            ...
            if self.keyslot.GetSelection() == 0:
                ...
                self.text_display.AppendText(output_message)
                self.text_display.AppendText(
                    "'trustm_rsa_verify -i datain.txt -s "
                    + outfile
                    + " -p rsa_e0fc_pub_1024.pem -H executed\n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                self.text_display.AppendText(
                    "'trustm_rsa_verify -i datain.txt -s "
                    + outfile
                    + " -p rsa_e0fd_pub_1024.pem -H executed\n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
            ...
            if self.keyslot.GetSelection() == 0:
                ...
                self.text_display.AppendText(
                    "'trustm_rsa_verify -i datain.txt -s "
                    + outfile
                    + " -p rsa_e0fc_pub_2048.pem -H executed\n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
                ...
                self.text_display.AppendText(
                    "'trustm_rsa_verify -i datain.txt -s "
                    + outfile
                    + " -p rsa_e0fd_pub_2048.pem -H executed\n"
                )
                self.text_display.AppendText("++++++++++++++++++++++++++++++++++++++++++++\n")
...
class Tab_AES(wx.Panel):
    def __init__(self, parent):
        ...
        self.aestype = wx.ComboBox(
            self, -1, choices=aestype_list, style=wx.CB_READONLY, size=wx.Size(170, 30)
        )
        self.aestype.SetFont(textctrlfont)

        text_keyusage = wx.StaticText(self, 0, "Key_usage:")
        self.keyusage = wx.ComboBox(
            self, 1, choices=keyusage, style=wx.CB_READONLY, size=wx.Size(178, -1)
        )
        self.keyusage.SetFont(textctrlfont)
        ...
        button_aesdec.SetToolTip(
            wx.ToolTip("Decrypt using AES CBC mode and output to mydata.txt.dec")
        )
        clearbutton.SetToolTip(wx.ToolTip("Clear all textboxes"))
        backbutton.SetToolTip(wx.ToolTip("Go back to main page."))
    ...
    def OnClickInputIV(self, evt):
        ...
        openFileDialog = wx.FileDialog(
            frame, "Open", "", "", "Binary|*.bin", wx.FD_OPEN | wx.FD_FILE_MUST_EXIST
        )
    ...
    def OnClickInputData(self, evt):
        ...
        openFileDialog = wx.FileDialog(
            frame, "Open", "", "", "All|*.*", wx.FD_OPEN | wx.FD_FILE_MUST_EXIST
        )
        filedir = config.IMAGEPATH + "/working_space/"
        openFileDialog.SetDirectory(filedir)
    ...
    def OnCreateKeyPair1(self, evt):
        self.command_display.AppendText(
            "Generating Trust M " + self.aestype.GetValue() + " key... \n"
        )
        self.command_display.AppendText(
    ...
    def OnEnc(self, evt):
        if self.datacheckbox.GetValue() == False:
            datain = self.input_display.GetValue()
            exec_cmd.createProcess("echo " + datain + " > mydata.txt")
    ...
    def OnNoIVFileSelected(self):
        infoDialog = wx.MessageDialog(
            ...
            "No Initialization File Selected",
            wx.OK | wx.ICON_INFORMATION,
        )
        infoDialog.ShowModal()
    ...
    def OnDec(self):
        ...
        #         self.Update()
        self.command_display.AppendText(
            "\n/trustm_symmetric_dec -m 0x09 -v"
            + iv
            + " -i "
            + aesenc
            + " -o mydata.txt.dec  is executed\n"
        )
        self.command_display.AppendText(
            "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
        )
