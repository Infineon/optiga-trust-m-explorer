...
class tab5Frame(wx.Frame):
    def __init__(self, parent, title):
       ...
       # Setup Publisher for text field update
        ...
        self.aws_endpoint.SetHint("Endpoint in Config file")
    ...
    def OnOneClick(self, evt):
        ...
        self.Update()
        self.bottom_txt_display.write("Creates new ECC 256 key length and Auth/Enc/Sign usage and generate a certificate request:\n")
        ...
        self.bottom_txt_display.write("'openssl req -new -engine trustm_engine -key 0xe0f1:^:NEW:0x03:0x13 -keyform engine -subj /CN=$commonname/O=$organisation/C=$country/ST=$countryfullname -out leaf.csr'\n")           
