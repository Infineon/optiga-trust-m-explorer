...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a1o8ed7vsgd4h5-ats.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "TrustM_IOT_DEVICE" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "TrustM_IOT_DEVICE" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "AmazonRootCA1.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "leafAWS.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "0xe0f1:^" ///< Device private key filename
// =================================================
